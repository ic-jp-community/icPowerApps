...
namespace ICApiAddin.icPowerApps
{
    public class SortData
    {
        ...
        public string name;
        public string depth;
        public string nameDepth;
        public IZElement parentElem;
        public IZElement elem;
        public eZElementType type;
        public SortData()
        {
            this.rowIndex = -1;
            this.name = string.Empty;
            this.depth = string.Empty;
            this.nameDepth = string.Empty;
            this.parentElem = null;
            this.elem = null;
            this.type = eZElementType.Z_ELEMENT_UNKNOWN;
        }
        public SortData(int rowIndex, string name, string depth, string nameDepth, IZElement parentElem, IZElement elem, eZElementType type)
        {
    ...
    public class NaturalComparer : IComparer<string>, IComparer
    {
        ...
        {
            SortData sort1 =  s1 as SortData;
            SortData sort2 = s2 as SortData;
            return LocalCompare(sort1.nameDepth, sort2.nameDepth) * _order;
        }
