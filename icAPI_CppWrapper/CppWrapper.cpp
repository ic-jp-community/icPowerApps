...
// CCppWrapperApp コンストラクション

CCppWrapperApp::CCppWrapperApp()
{
...
// 唯一の CCppWrapperApp オブジェクトです。

CCppWrapperApp theApp;
...
CWnd* HwndToCwnd(HWND* hwnd) {
	CWnd *pWnd = CWnd::FromHandle((HWND)hwnd);
	return pWnd;
}

INT64 CwndToHwnd(CWnd* pCWnd) {
